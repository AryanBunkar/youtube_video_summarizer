...
def get_transcript(video_id: str) -> str:
    proxy_username = st.secrets.get("WEBSHARE_USERNAME") or os.environ.get("WEBSHARE_USERNAME")
    proxy_password = st.secrets.get("WEBSHARE_PASSWORD") or os.environ.get("WEBSHARE_PASSWORD")
